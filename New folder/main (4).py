...
class LiveTab(ctk.CTkFrame):
    ...
    def _upd_ui(self, r):
        ...
        if "frame" in r:
            f = r["frame"].copy()
            bb = r.get("face_bbox")
            col = ((0, 210, 80) if trust >= 60 else
                   (255, 210, 0) if trust >= 40 else (255, 50, 50))
            if bb:
                x, y, w, h = bb
